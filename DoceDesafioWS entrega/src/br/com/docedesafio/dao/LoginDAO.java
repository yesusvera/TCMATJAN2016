...
public class LoginDAO extends BaseDAO<Usuario> {
	...
	public void delete(int id) {
		new AlimentoDAO().deleteByIdLogin(id);
		new ExercicioDAO().deleteByIdLogin(id);
		new GlicemiaDAO().deleteByIdLogin(id);
		new InsulinaDAO().deleteByIdLogin(id);
		new RefeicaoDAO().deleteByIdLogin(id);
		new PerfilDAO().deleteByIdLogin(id);
